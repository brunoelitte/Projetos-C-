...
int votar(Celula *Lista, int Iden)
{
	...
	if(P == NULL)
		...
		P->voto +=1;
		printf("Voc� votou no %s", P->Candidato);
		return 1;}
}
...
{
	int Opcao, Flag=0;
	printf("                     PESQUISA DE INTENCAO DE VOTOS                       \n");
	...
	printf("DIGITE A OPC�O QUE DESEJA:");scanf("%d", &Opcao);fflush(stdin);
	 
	while(Flag == 0){ 
		if(Opcao == 1 || Opcao == 2 || Opcao == 3 || Opcao == 4)
			Flag = 1;
		else{
			printf("\nOP��O INV�LIDA! Digite novamente: ");scanf("%d", &Opcao);fflush(stdin);}}
	*Valida = Opcao;
}
			...
			while (Opcao == 1){
				...
				switch (Fazer){
					...
					case 2:
						Testa = 0;
						listaCandidatos(DeputFederal);
						printf("Digite o n�mero do candidato para alterar: ");scanf("%d", &Candidato);fflush(stdin);
						Testa = alterar(DeputFederal, Candidato);
						while(Testa == 0)
						{
							printf("Candidato n�o encontrado, tente novamente. Ou digite -1 para voltar ao Menu Anterior.\n");
					...
					case 3:
						Testa = 0;
						listaCandidatos(DeputFederal);
						printf("Digite o n�mero do candidato para remover: ");scanf("%d", &Remove);fflush(stdin);
					...
					case 4:
						Testa = 0;
						listaCandidatos(DeputFederal);
						printf("Digite o n�mero do candidato para votar: ");scanf("%d", &Votar);fflush(stdin);
					...
					case 5:
							...
							{
								printf("Nenhum voto computado at� o momento.");
								system("pause");
							}
						break;
					case 6:
